...
def filter(line):
	...
	return True
def run():
	cmd = '''cd /Users/playcrab/Documents/svn/kosdt/kosres_branch
xrun synclocal -b branch -d /Users/playcrab/Documents/svn/kosdt/data/branch/branch.200107 -r /Users/playcrab/Documents/svn/kosdt/kosres_branch -o /Users/playcrab/Documents/svn/kosdt/DTBranchEnvironment/Resources -l kosdt_preonline --updatalua --updatadata --updatares --comitsvn --dingding'''
	...
	if len(need_warning_lines)>0:
		...
		_dingding_notify("synclocal", 
		    ...
		    "https://oapi.dingtalk.com/robot/send?access_token=2c0d4fb7dd7fc2500b22222368a9a0912e2dbebe9a753d3902f53e4f1d17417b"
		    )
run()
